...
-- Video library (reference links to the player's own cloud — we never host)
insert into video_asset(org_id, player_id, team_id, bucket, title, url, provider, visibility, created_by) values
  ('11111111-1111-1111-1111-111111111111','a0000000-0000-4000-8000-000000000003','22222222-0000-4000-8000-000000000001','interview','Nick — recruiting intro','https://youtu.be/example-nick','youtube','org','a0000000-0000-4000-8000-000000000001'),
